...
long IRremote_data(){
  // Using command value for IRremote 4.6.1
  uint8_t cmd = IrReceiver.decodedIRData.command;

  if(cmd == 0x18){IR_data=1;}  
  else if(cmd == 0x52){IR_data=2;} 
  else if(cmd == 0x08){IR_data=3;} 
  else if(cmd == 0x5A){IR_data=4;} 
  else if(cmd == 0x1C){IR_data=5;} 
  else if(cmd == 0x45){IR_data=8;} 
  else if(cmd == 0x46){IR_data=9;} 
  else if(cmd == 0x47){IR_data=10;} 
